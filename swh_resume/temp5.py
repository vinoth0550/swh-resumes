...
# temp5.py -template 5 without banner section and added job role section
...
TEMPLATES = {
    ...
    "Refined Garamond": {
        ...
        "text": colors.black,
        "sidebar_bg": colors.HexColor("#9E8FAA"),     # ("#FDFDFD")  ("#C4B97D")
    ...
    def draw_content(y_position, sidebar_data, main_data, start_sidebar_idx=0, start_main_idx=0, start_sidebar_line=0, start_main_line=0):
        ...
        if start_sidebar_idx == 0 and start_main_idx == 0:
            ...
            if data.get("job_role"):
                ...
                c.setFillColor(colors.HexColor("#2E2E2E"))# White text for contrast
...
###
    ...
    try:
        ...
        style = TEMPLATES['Refined Garamond']
